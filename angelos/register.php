...
<body>
	...
	<section class="login">
		...
		<div class="login-container">
			...
			<form class="fcon" action="register.php" method="post">
				...
				<div class="form1" id="form1">
					...
					<div class="input-div">
						...
						<div>
							<input type="text" value="" name="regUser" class="input" id="regUser" placeholder="Username" autofocus required>
						</div>
					</div>
			...
			if (isset($_POST["register"])) {
				...
				$sql = "SELECT * FROM account_tbl WHERE user='$regUser'";
				$result = $conn->query($sql);

				$insert = "INSERT INTO account_tbl VALUES ('DEFAULT', '$regUser', '$regPass', '$fname', '$lname', '$email', '$phone', '$country', '$province', '$address', '$pcode')";
				...
				if (!empty($_POST['regUser']) && !empty($_POST['regPass'])) {
					if ($result->fetch_assoc()) {
						...
						document.getElementById("warning2").innerHTML = "Account Already Exist!!";
						...
						document.getElementById("warning2").innerHTML = "Account Registered Successfully!!";

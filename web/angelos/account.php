    ...
    <header class="header">
        ...
        <nav>
            <ul class="navbar">
                ...
                <li><a id="nav5" class="active" href="#">Account</a></li>
                    ...
                    <form action="#">
                        ...
                        <div class="form-details">
                            ...
                            <div class="input-box">
                                ...
                                <input type="text" placeholder="Niel Angelo" required>
                            </div>
                            <div class="input-box">
                                <label>Last Name</label>
                                <input type="text" placeholder="Gencaya" required>
                            </div>
                            <div class="input-box">
                                <label>Email Address</label>
                                <input type="text" placeholder="nielangelo@gmail.com" required>
                            </div>
                            <div class="input-box">
                            ...
                            <div class="input-box">
                                ...
                                <select id="country" name="country" class="form-control" required>
                                    <option value="" disabled selected hidden>Philippines</option>
                            ...
                            <div class="input-box">
                                ...
                                <input type="text" placeholder="Kabankalan City" required>
                            </div>
                            <div class="input-box">
                                <label>Home Address 2</label>
                                <input type="text" placeholder="Bacolod City" required>
                            </div>
                            <div class="input-box">
                                <label>Postal Code</label>
                                <input type="text" placeholder="6111" required>
                            </div>
